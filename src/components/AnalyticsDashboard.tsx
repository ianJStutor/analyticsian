    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
                <Card className="w-full bg-indigo-950 ring-indigo-900">
            ...
            <Card className="flex flex-col sm:grid grid-cols-4 gap-6 bg-indigo-950 ring-indigo-900">
            ...
            <Card className="bg-indigo-950 ring-indigo-900">
                {timeseriesPageviews ? (
                    <BarChart
                        allowDecimals={false}
                        showAnimation
